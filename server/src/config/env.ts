...
export function getEnv(): ServerEnv {
  ...
  cachedEnv = {
    ...
    SUPABASE_ANON_KEY: requireValue('SUPABASE_ANON_KEY', process.env.SUPABASE_ANON_KEY),
    SUPABASE_SERVICE_ROLE_KEY: requireValue('SUPABASE_SERVICE_ROLE_KEY', process.env.SUPABASE_SERVICE_ROLE_KEY),
  };
