...
export function getCreateTableStatements() {
  return [
    `create table if not exists app_state (
      ...
      auth_mode text,
      microphone_permission text not null default 'pending',
      storage_permission text not null default 'pending',
      tutorial_shown integer not null default 0,
      guest_converted integer not null default 0,
